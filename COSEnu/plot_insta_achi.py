    ...
    for hi in os.listdir(pth):
        ...
        if 'png' not in hi:
            if 'jpg' not in hi:
                ...
                if small == True:
                    sfn = "./f_insta_achi/prd_insta_map_small_bi_Lmu_"+Lmu+"tick.jpg"
                else:
                    sfn = "./f_insta_achi/prd_insta_map_big_bi_Lmu_"+Lmu+"tick.jpg"
                if 'ar' and 'deg' in hi:
                    print('haha')
                    ar = (dtn[dtn.find('_ar_')+4:dtn.find('_deg_')])
                    deg = (dtn[dtn.find('_deg_')+5:dtn.find('.npy')])
                    if small == True:
                        nfn = "./f_insta_achi/exp_insta_map_small_bi_Lmu_"+Lmu+"_ar_"+ar+"_deg_"+deg+"_tick.jpg"
                    else:
                        nfn = "./f_insta_achi/exp_insta_map_big_bi_Lmu_"+Lmu+"_ar_"+ar+"_deg_"+deg+"_tick.jpg"
                    sfn=nfn
                else: 
                    nfn=sfn
                """print((sfn))   
